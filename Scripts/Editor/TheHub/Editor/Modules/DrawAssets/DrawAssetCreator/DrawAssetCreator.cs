...
namespace OdinUtils.TheHub
{
    ...
    public class DrawAssetCreator<T> : DrawAssetCreator where T : ScriptableObject
    {
        ...
        [HorizontalGroup(HorizontalCreateNew, 0.8f, 0, 10)]
        [VerticalGroup(HorizontalCreateNew + "/Path")]
        [FolderPath, LabelText("Folder"), LabelWidth(LabelWidth)]
        [SerializeField]
        private string _folderPath;

        [VerticalGroup(HorizontalCreateNew + "/Path")]
        [LabelWidth(LabelWidth), SerializeField]
        ...
        [GUIColor("@Color.green"), Button("Create")]
